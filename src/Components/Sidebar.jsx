            ...
            <div className='sidebar'>
                <div className='sidebar_profile'>
                    ...
                    <div className='sidebar_details'>
                        <Avatar className='profile_pic' src='https://images.unsplash.com/photo-1588862081167-d5b98006637e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8YmF0bWFufGVufDB8fDB8fHww&auto=format&fit=crop&w=500&q=60'/>
                        <h3 className='text-lg mt-5 font-semibold'>Pruthvi Bhat</h3>
